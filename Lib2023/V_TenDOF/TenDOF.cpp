...
bool IMU_m::GetAccel(double * bf_)
{
    if(mpu_ob.accelUpdate()==0)
    {
		...
		bf_[0]=buf[0]*CalibAccel[1][0] + buf[1]*CalibAccel[2][0] + buf[2]*CalibAccel[3][0];
		bf_[1]=buf[0]*CalibAccel[1][1] + buf[1]*CalibAccel[2][1] + buf[2]*CalibAccel[3][1];
		bf_[2]=buf[0]*CalibAccel[1][2] + buf[1]*CalibAccel[2][2] + buf[2]*CalibAccel[3][2];
